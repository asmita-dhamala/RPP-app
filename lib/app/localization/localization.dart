...
import 'package:raparva_app/core/constants/constant.dart';
...
class AppLocalization {
  ...
  String? translate(String? key) {
    // throwIf(_localizedValues[key] == null, 'key [$key] is missing'); // useful to find if any words are not included in language
...
class _DemoLocalizationsDelegate
  ...
  bool isSupported(Locale locale) {
    ...
    for (var language in Constant.languages) {
